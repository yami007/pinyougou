...
//    状态值：  0：未审核   1：已审核   2：审核未通过   3：已关闭
    private static final String UN_CHECK = "0";
    private static final String IS_CHECK = "1";
    private static final String NOT_PASS = "2";
    private static final String CLOSE = "3";

    public static String getUnCheck() {
        return UN_CHECK;
    }
