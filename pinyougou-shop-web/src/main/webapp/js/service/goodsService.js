...
app.service('goodsService',function($http){
	...
	this.search=function(page,rows,searchEntity){
		return $http.post('../tbgoods/search.do?page='+page+"&rows="+rows, searchEntity);
	}
	//下架
	this.marketable=function (selectIds) {
        return $http.post('../tbgoods/marketable.do?ids='+selectIds);
    }
});
